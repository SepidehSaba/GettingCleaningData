...
#create a working directory folder to download and extract data
...
#In this part,a second, independent tidy data set will be created with 
#the average of each variable for each activity and each subject based on the data set in step 4.
